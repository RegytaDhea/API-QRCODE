...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-lg"><b>Kelas</b></span>
    </a>
            ...
            <tbody>
                @foreach ($kelas as $k)
                    <tr>
                        ...
                        <td>{{ $k->kelas }}</a></td>
                        <td>{{ $k->kapasitas }}</a></td>
                        <td>{{ $k->paket_semester }}</a></td>
                        <td>{{ $k->id_th_ajaran }}</a></td>
                        <td>{{ $k->kode_mk }}</a></td>
                        <td>{{ $k->nip_dosen }}</a></td>
                        <td>
                                <a href="{{ url('/index/'.$k->id) }}" button type="submit" class="btn btn-danger btn-sm">Pilih</button>
                        </td>
                    </tr>
