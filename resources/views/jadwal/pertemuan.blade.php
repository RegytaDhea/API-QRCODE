...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/') }}" class="logo">
      ...
      <span class="logo-lg"><b>Pertemuan</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="activate"><a href="{{url('/kelas')}}"><i class="fa fa-circle-o"></i> Kelas </a></li>
    </section>
    <!-- /.sidebar -->
  </aside>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ url('/pertemuan/create/'.$id_jadwal) }}">Tambah Pertemuan</a></li>
      </ol>
    </section>
        ...
        <tbody>
            @foreach ($pertemuan as $p)
                <tr>
                    ...
                    <td>{{ $p->id_jdwl }}</a></td>
                    <td>{{ $p->nip_dosen }}</a></td>
                    <td>{{ $p->kesesuaian_rkps }}</a></td>
                    <td>{{ $p->capaian }}</a></td>
                    <td>{{ $p->waktu_mulai }}</a></td>
                    <td>{{ $p->waktu_selesai }}</a></td>
                    <td>{{ $p->keterangan }}</a></td>
                    <td>{{ $p->materi }}</a></td>
                    <td>
                            <a href="{{ url('/pertemuan/qrcode') }}" button type="submit" class="btn btn-danger btn-sm">Tampilkan QRCode</button>
                    </td>
                </tr>
            @endforeach
        </tbody>
